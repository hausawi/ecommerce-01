    ...
    <div className='border-t pt-14'>
      ...
      <div>
          {cartData.map((item, index) => {
            ...
            return (
              <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr-0.5fr] items-centergap-4'>
                <div className='flex items-start gap-6'>
                  ...
                  <div>
                    ...
                    <div className='flex items-center gap-5 mt-2'>
                      ...
                      <p className='px-2 sm:px-3 sm:py-1 border bg-[#5BAEB7]'>{item.size}</p>
                    </div>
                  </div>
                </div>
